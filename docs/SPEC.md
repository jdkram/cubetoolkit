...
| Primary contributor | ben@ouat.co.uk (~1,434 commits) |
| Second contributor | marcus@marcusv.org (~234 commits) |
...
The right near-term sequence remains what see ROADMAP.md for sequencing already describes:
...
The JSON fixtures map directly to the data model described in section 8.
